...
{
    public partial class AddEntityToDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2022, 5, 25, 14, 28, 47, 309, DateTimeKind.Local).AddTicks(7519), false, "Admin", null, null });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "InsertTime", "IsRemoved", "Name", "RemoveTime", "UpdateTime" },
                values: new object[] { 2L, new DateTime(2022, 5, 25, 14, 28, 47, 317, DateTimeKind.Local).AddTicks(4328), false, "Operator", null, null });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "InsertTime", "IsRemoved", "Name", "RemoveTime", "UpdateTime" },
                values: new object[] { 3L, new DateTime(2022, 5, 25, 14, 28, 47, 317, DateTimeKind.Local).AddTicks(4596), false, "Customer", null, null });
